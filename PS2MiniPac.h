/*
  PS2MiniPac.h - PS2Keyboard library
...
extern const PROGMEM PS2Keymap_t PS2Keymap_MiniPac;
...
class PS2MiniPac {
  public:
     ...
     */
    static void begin(uint8_t dataPin, uint8_t irq_pin, const PS2Keymap_t &map = PS2Keymap_MiniPac);
